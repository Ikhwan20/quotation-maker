...
const DEFAULT_ALL_BQ_ITEMS = [
    {
        code: "SR1",
        section: "A",
        jkrStage: "stage1",
        category: "1. GENERAL ITEM",
        categoryEn: "1. GENERAL ITEM",
...
let ALL_BQ_ITEMS = [];
try {
    const storedBq = localStorage.getItem('LLS_CUSTOM_BQ_ITEMS');
    if (storedBq) {
        ALL_BQ_ITEMS = JSON.parse(storedBq);
    } else {
